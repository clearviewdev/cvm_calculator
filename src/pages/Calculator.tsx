    ...
    <main className="bg-white dark:bg-black relative">
      ...
      <div className="mx-auto max-w-7xl px-4 lg:px-0">
        <div className="px-6 py-4 mb-8 rounded-lg">
          <h1 className="text-4xl font-bold tracking-tight text-blue-700 dark:text-white text-center">
            Commission Rate Calculator
          </h1>
          <p className="text-lg text-gray-800 dark:text-gray-300 mt-6 text-center">
            An agent commission calculator that efficiently computes commissions
            based on policies sold, ensuring accurate and transparent
            compensation.
          </p>
        </div>
        <div className="flex flex-col-reverse lg:flex-row items-center justify-between">
          <div className="w-full lg:w-1/2">
            <Calculator form={form} setForm={setForm} scroll={executeScroll} />
          </div>
          <div
            ref={scrollRef}
